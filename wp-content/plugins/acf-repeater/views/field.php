...
?>
<?php if( $field['layout'] != 'tablenonheader' ): ?>
	<div class="repeater" data-layout="<?php echo $field['layout']; ?>" data-min_rows="<?php echo $field['row_min']; ?>" data-max_rows="<?php echo $field['row_limit']; ?>">
		...
		<?php if( $field['value'] ): foreach( $field['value'] as $i => $value ): ?>
			...
			<?php if ($i != 0) { ?>
				<tr class="acf-rowspacer"><td colspan="3" style="background-color: #f1f1f1 !important;"></td></tr>
			<?php } ?>
...
<?php else: ?>
	<div class="repeater" data-layout="<?php echo $field['layout']; ?>" data-min_rows="<?php echo $field['row_min']; ?>" data-max_rows="<?php echo $field['row_limit']; ?>" style="width: 100% !important">
		<table class="widefat acf-input-table acf-input-innertable <?php if( $field['layout'] == 'row' ): ?>row_layout<?php endif; ?>" style="border: 1px solid #f1f1f1 !important; width: 100% !important" >
		<tbody>
		<?php if( $field['value'] ): foreach( $field['value'] as $i => $value ): ?>
