...
<table class="acf_input widefat" id="acf_options">
	...
	<tr>
		<td class="label">
			<label for="post_type"><?php _e("Hide on render",'acf'); ?></label>
		</td>
		<td>
			<?php 
	...
	<tr>
		<td class="label">
			<label for="post_type"><?php _e("Title required",'acf'); ?></label>
		</td>
		<td>
			<?php 
			...
			do_action('acf/create_field', array(
				'type'		=>	'radio',
				'name'		=>	'options[titlerequired]',
				'value'		=>	$options['titlerequired'],
				'layout'	=>	'horizontal',
				'choices'	=>	array(
					'yes' => __('Yes', 'acf'),
					'no' => __('No', 'acf'),
