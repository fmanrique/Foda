...
class acf_field_group
{
	...
	*/
	...
	function get_options( $options, $post_id )
	{
		...
		$hide = get_post_meta($post_id, 'hide', true);
	 	if( $hide )
		{
			$options['hide'] = $hide;
		}

		$titlerequired = get_post_meta($post_id, 'titlerequired', true);
	 	if( $titlerequired )
		{
			$options['titlerequired'] = $titlerequired;
		}
	...
	function save_post($post_id)
	{
		...
		*/
		...
		if( isset($_POST['options']) && is_array($_POST['options']) )
		{
			...
			update_post_meta($post_id, 'hide', $_POST['options']['hide']);
			update_post_meta($post_id, 'titlerequired', $_POST['options']['titlerequired']);
		}
